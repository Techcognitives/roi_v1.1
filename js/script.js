...
function calculateRoi(){
  ...
  var incrementRYear= roiircw*weeksForYear/12
   ...
   annualRevenueCashPay= roiircw*weeksForYear;
...
function calculateRoiAsp(){
  ...
  $("#tab2_row_3_5").text("$"+Math.round(aspAnnualNetRevenue))
   ...
   var grandTotalMonthlyNetRevenue = annualRevenueCashPay+totalIncrementHaRevenueForYear;
   var grandTotalMonthlyNetRevenueAfterSfc = grandTotalMonthlyNetRevenue-monthlySFC;

   var grandTotalYearlyNetRevenue = totalIncrementHaRevenueForYear+annualRevenueCashPay;
